...
<body>
<form name="addPurchase" method="post" action="/minishop/purchase/addPurchase">
...
<input type="hidden" name="prodNo" value="${provo.prodNo}"></input>
<table width="600" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<td class="ct_write01"><input type="text" name="receiverRequest"
			class="ct_input_g" style="width: 100px; height: 19px" maxLength="20" /></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td width="200" class="ct_write01"><input type="text" name="receiverDate" class="ct_input_g" style="width: 100px; height: 19px"
					maxLength="20"/>
		</td>
	</tr>
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td background="/images/ct_btnbg02.gif" class="ct_btn01"
					style="padding-top: 3px;"><input type="submit" value="구매"></td>
