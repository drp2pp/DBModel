...
function fncCheckDuplication() {
	...
	if(document.detailForm.userId.value != null && document.detailForm.userId.value.length >0) {
	    ...
	    document.detailForm.action='/minishop/user/checkDuplication';
		...
		<td class="ct_write01">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="105">
<c:if test="${result }">
						<input type="text" name="userId" id="userId" value="${user.userId}" class="ct_input_g" style="width:100px; height:19px"  maxLength="20" >
</c:if>
<c:if test="${!result }">		
