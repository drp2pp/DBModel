...
function fncAddProduct(){
	...
	document.detailForm.action='/minishop/product/addProduct';
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td width="104" class="ct_write">제조일자 <img
			src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"></td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><input type="text" name="manuDate" class="ct_input_g"
			style="width: 100px; height: 19px" maxLength="10" minLength="6">&nbsp;
			
			<!-- <img
			src="../images/ct_icon_date.gif" width="15" height="15"
			onclick="fnPopUpCalendar(this,manuDate,'yyyy-mm-dd')"></img> -->
