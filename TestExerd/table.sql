...
COMMENT ON COLUMN LOCAL_INFO.GPS_X IS 'GPS_X';

COMMENT ON COLUMN LOCAL_INFO.GPS_Y IS 'GPS_Y';
...
CREATE TABLE DATA_INFO (
	...
	DATA_FILE_ADD VARCHAR(255) NOT NULL, /* 파일경로 */
...
COMMENT ON COLUMN DATA_INFO.DATA_FILE_ADD IS '파일경로';
